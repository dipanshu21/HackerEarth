...
/**
 * Created by deepanshu on 17/05/16, 8:27 AM.
 */
class $042_CodedTriangleNumber {
    ...
    private static String getResult() {
        int[] a = getInput();
        boolean[] dp = new boolean[400];
        int curSum = 0;

        for (int i = 1; curSum < dp.length; i++) {
            dp[curSum] = true;
            curSum += i;
        }
    ...
    private static int[] getInput() {
        ...
        for (int i = 0; i < input.length; i++) {
            intInput[i] = getScore(input[i]);
        }

        return intInput;
    }

    private static int getScore(String a) {
        int s = 0;
