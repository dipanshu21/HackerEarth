...
/**
 * Created by deepanshu on 16/05/16, 9:31 AM.
 */
class $036_DoubleBasePalindrome {
    ...
    private static String getResult() {
        ...
        int i = 1;
        int p = NumberUtil.makePalinDromBase2(i, true);

        while (p < LIMIT) {
            sum += NumberUtil.isPalindrome(p, 10) ? p : 0;
            i++;
            p = NumberUtil.makePalinDromBase2(i, true);
        }


        i = 1;
        p = NumberUtil.makePalinDromBase2(i, false);
