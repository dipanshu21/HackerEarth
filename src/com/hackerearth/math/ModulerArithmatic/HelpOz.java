...
/**
 * Created by deepanshu on 28/08/16, 18:13.
 */
class HelpOz {
    ...
    * */
    ...
    private static boolean divides(int[] arr, int k) {
        int val = arr[0] % k;
